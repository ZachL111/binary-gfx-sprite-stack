"""Regression checks for the binary-gfx-sprite-stack casebook."""
...
from casebook.harness import assert_expected, binary_gfx_sprite_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(binary_gfx_sprite_stack_summary(), assert_expected())
