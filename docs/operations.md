...
`binary-gfx-sprite-stack` is centered on graphics work in Dart. The technical target is: Design a Dart verification harness for sprite systems, covering graph analysis, node-edge fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 177. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 6.
